        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary card">
                ...
                <div class="panel-body card-body">
                    <form action="{{ route('simplecms.archivos.store', $entidad->getId()) }}" class="form-horizontal"
                        ...
                        <div class="form-group row {{ $errors->has('archivos') ? 'has-error':'' }}">
                            <label class="col-md-2 control-label text-right" for="archivos">Archivos</label>
                            <div class="input-group col-md-6">
                                <input id="archivos" name="archivos[]" class="form-control input-md" type="file"
                                       multiple>
    ...
    @if(count($archivos))
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                ...
                <div class="panel panel-primary card">
                    <div class="panel-heading card-header">Archivos de "{{ $entidad }}"</div>
                    <div class="panel-body card-body">
                        @foreach($archivos as $archivo)
                            <div class="col-md-6 col-md-offset-3 mb5">
                                <form action="{{ route('simplecms.archivos.destroy', $archivo->getId()) }}"
                                      method="POST" class="dinline" onsubmit="return confirm('¿Está seguro?')">
                                    {!! csrf_field() !!}
                                    {!! method_field('delete') !!}
